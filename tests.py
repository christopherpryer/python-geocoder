...
import pandas as pd
from batch_geocoder import PgeocodeHelper
...
def test_batches():
    ...
    cad_helper = PgeocodeHelper(partition_size=2, storage_dir=storage_dir,
        country='ca')
    us_helper = PgeocodeHelper(partition_size=2, storage_dir=storage_dir,
        country='us')
